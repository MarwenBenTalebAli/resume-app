...
export class UserService {
  ...
  user: User = new User();
  // (
  // { fr: 'GOUVERNORAT DE SOUSSE, TUNISIE' },
  // {
  //   fr: `J'ai de bonnes compétences en développement d'applications desktop et web.     Je suis un jeune homme dynamique qui cherche à mettre son énergie     et ses compétences dans le domaine du développement informatique.`,
  // },
  // 'marwen.bentaleb@gmail.com',
  // {
  //   fr: 'drive.google.com/file/d/1AGKL4lnSxciwl4wMzyI2bQ10LdY5s_YH/view?usp=sharing',
  // },
  // 'github.com/MarwenBenTalebAli',
  // 'www.linkedin.com/in/dev-web',
  // 'MARWEN',
